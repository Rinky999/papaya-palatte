            ...
            <section class="page-register page-bg-color">
                <div class="box-form">
                    <form action="#" class="form d-flex flex-column">
                        ...
                        <input type="text" name="" class="input-reset form__input" placeholder="User ID or Email" />

                        <input type="password" name="" class="input-reset form__input" placeholder="Password" />
                        ...
                        <button class="link__template second-bg-color  btn-hover-animate d-flex align-items-center justify-content-center">
